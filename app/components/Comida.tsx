        ...
        {abrir && (
          <div className="form">
            ...
            <div className="form-bottom">
              ...
              />
              <button className="confirm-btn" onClick={añadir}>AÑADIR</button>
            </div>
          </div>
        )}
...
const CSS = `
  * { box-sizing: border-box; margin: 0; }
  ...
  .resumen-bar { height:12px; background:#1a0f0a; border:2px solid var(--ink); border-radius:3px; overflow:hidden; }
  ...
  /* FORMULARIO */
  .form { background:#1c1410; border:2px solid var(--amber); border-radius:8px; padding:12px; margin-bottom:14px;
