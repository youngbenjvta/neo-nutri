...
// 6 avatares guerreros: cada uno es un SVG simple con su color de aura.
const AVATARS = [
...
function WarriorSVG({ aura, hair }: { aura: string; hair: string }) {
  return (
    <svg viewBox="0 0 100 100" className="warrior">
      <circle cx="50" cy="50" r="46" fill="none" />
      {/* cabello en pico (shonen) */}
